...
//void Subject::Attach(std::unique_ptr<IObserver> observer) {
//    list_observer.push_back(observer);
//}
//void Subject::Detach(std::unique_ptr<IObserver> observer) {
...
//    this->subject_.Attach(std::unique_ptr<IObserver>(this));
//}
...
//    subject_.Detach(std::unique_ptr<IObserver>(this));
//}
